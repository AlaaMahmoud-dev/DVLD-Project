...
namespace DVLD_Project
{
    public partial class frmMain : Form
    {
        ...
        {
            frmIssueNewInternationalDrivingLicense newInternationalDrivingLicense
                = new frmIssueNewInternationalDrivingLicense();
            newInternationalDrivingLicense.Show();
        }
    }
}
